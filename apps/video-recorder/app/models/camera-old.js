...
var Camera		= {
	...
	preview:	{
		...
		configCamera:	function(duration){
			...
			config.framerate		= Camera.params.camera.framerate;
	...
	record:	{
		...
		init:		function(params){
			...
			this.consent	= params.consent === 'true' || false;
			this.successCB	= params.successCB;
			this.errorCB	= params.errorCB;
			this.configCamera(params.duration);
			this.events.init();
